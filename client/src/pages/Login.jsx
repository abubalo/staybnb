    ...
    <div className="flex h-80v  justify-center items-center">
        ...
        >
          ...
          <input
            ...
            onBlur={formik.handleBlur}
          />
          <div onClick={() => setVisible(!visible)} className="absolute text-slate-400 cursor-pointer right-3 translate-y-2">
                {visible ? (
                  <svg
          ...
          <button type="submit" className="primary font-semibold">Login</button>
          <small>
            Not yet a user? <Link to="/register" className="font-medium text-primary hover:text-primaryLight">Create account</Link>
          </small>
        </form>
    </div>
  );
